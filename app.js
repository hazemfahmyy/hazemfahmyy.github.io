...
function initStoryCanvas() {
    ...
    function draw() {
        ...
        if (currentStoryStep === 1) { 
            // ----------------------------------------------------
            // PHASE 1: MPC KINEMATICS (Fixed Map Structure with Flow)
            // ----------------------------------------------------
            // Completely locked/grounded road curve mathematics (Time removed to fix oscillation)
            ...
            // Target Centerline (Animate dash offset to create motion flow seamlessly)
            ctx.save();
            ctx.beginPath(); 
            ...
            // System Kinematic Heading Vector
            ctx.beginPath(); ctx.moveTo(0, 0); ctx.lineTo(35, 0);
            ctx.strokeStyle = '#10b981'; ctx.lineWidth = 2; ctx.stroke();
            ctx.restore();
            
            // On-Screen HUD Overlay Diagnostics Text
